...
class VenueController extends Controller
{
    ...
    {
        $venue = DeliveryVenue::findOrFail($id);
    ...
    public function update(Request $request)
    {
        ...
        $venue = DeliveryVenue::findOrFail($request->id);
    ...
    public function list()
    {
        ...
        $venue = DeliveryVenue::orderBy($sort, $order);
    ...
    {
        $ws = DeliveryVenue::findOrFail($id);
        $ws->delete();
