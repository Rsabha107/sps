...
class BookingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('mds.customer.booking.list', compact(
            'bookings',
            // 'intervals',
            'venues',
            'rsps',
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mds.customer.booking.confirmation')->with($notification)->with('booking_id', $booking->id);
    ...
    public function confirmation()
    {
        ...
        if ($booking_id) {
            $booking = DeliveryBooking::findOrFail($booking_id);
            return view('mds.customer.booking.confirmation', ['data' => $booking]);
        } else {
            return redirect()->route('mds.customer.booking');
        }
    }
    ...
    public function save_pass_pdf($booking)
    {
        ...
        $url = route('mds.operator', $booking->id);
