...
function imageFormatter(value, row, index) {
    if (!value)
        return `<img src="/storage/event/logo/noimage.png" alt="event image" width="60" class="rounded-circle pull-up">`;
    return `<img src="/storage/event/logo/${value}" alt="event image" width="60" class="rounded-circle pull-up">`;
}
