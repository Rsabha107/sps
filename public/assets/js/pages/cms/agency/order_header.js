...
$(document).ready(function () {
    ...
    $("body").on("click", "#editOrderStatus", function (event) {
        ...
        $.get("/cms/agency/orders/status/edit/" + id, function (data) {
    ...
    $("body").on("click", "#show_order_lines", function () {
        ...
        let url = `/cms/agency/orders/${orderId}/modal`;
    ...
    $("body").on("click", "#attachment_list", function () {
        ...
        $.ajax({
            url: "/cms/agency/orders/attachments/" + id,
            method: "GET",
            async: true,
    ...
    $("body").on("click", "#edit_purchase_offcanv", function () {
        ...
        console.log("id", id);
        $.ajax({
            url: "/cms/agency/orders/mv/edit/" + id,
            method: "GET",
            async: true,
            success: function (response) {
                g_response = response.view;
    ...
    $("body").on("click", "#delete_purchase", function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/cms/agency/orders/delete/" + id,
                    type: "DELETE",
                    headers: {
