          ...
          <nav class="navbar navbar-expand-lg navbar-light px-0">
            <div class="row gx-0 gy-2 w-100 flex-between-center">
              <div class="col-auto"><a class="text-decoration-none" href="">
                  <div class="d-flex align-items-center"><img src="{{ asset(config('settings.website_logo')) }}" alt="phoenix" width="27" />
                    <h6 class="logo-text ms-2">{{ config('settings.website_name') }}</h6>
                  </div>
                </a>
              </div>
                  ...
                  <li class="nav-item d-flex align-items-center">
                   ...
                   {{-- <li class="nav-item">
                    <a class="nav-link px-2 icon-indicator icon-indicator-primary" href="../../../apps/e-commerce/landing/cart.html" role="button">
                      <span class="text-body-tertiary" data-feather="shopping-cart" style="height:20px;width:20px;">
                        </span><span class="icon-indicator-number">3</span
                          ></a>
                  </li> --}}
