                    ...
                    <div class="card-header">
                        <div class="row gy-3 justify-content-between">
                            <div class="col-md-9 col-auto">
                                <h5 class="mb-2 text-body-emphasis">Create Order</h5>
                                <h6 class="text-body-tertiary fw-semibold">Fill the form below to create a new order</h6>
                            </div>
                        ...
                        {{-- <div class="ms-3">
                            ...
                            <span class="text-muted fs-xs">Fill the form below to create a new order</span>
                        </div>
                        <div class="ms-3">
                            <h5 class="mb-0 fs-sm">Create Order</h5>
                            <span class="text-muted fs-xs">Fill the form below to create a new order</span>
                    ...
                    {{-- <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <x-formy.form_select class="col-sm-6 col-md-3 mb-3" floating="1" selectedValue=""
                                ...
                                :forLoopCollection="$contractors" itemIdForeach="id" itemTitleForeach="name" style=""
                                addDynamicButton="0" />
                            ...
                            <table class="table table-hover" id="add_item">
                                ...
                                <tbody>
                                    <tr id="row_1">
                                        ...
                                        {{-- </td> --}}
                                        <td>
                                            <input class="form-control quantity form-control-sm" type="number"
                                                min="1" value="1" name="quantity[]" id="quantity_1"
                                                required>
                                        </td>
                                        <td>
...
<script type="text/javascript">
    ...
    var SmartAuto = (function() {
        ...
        function autoFillItem() {
            ...
            // console.log(rowNo)
            $.ajax({
                url: "/cms/contractor/item/get/" + itemId,
                method: "GET",
                async: false,
