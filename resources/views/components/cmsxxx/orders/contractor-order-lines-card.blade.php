    ...
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table id="order_table" data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                ...
                data-url="{{route('cms.contractor.orders.lines.list')}}"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-sortable="true" data-field="line_id"><?= get_label('line_id', 'Line Id') ?></th>
                        ...
                        <th data-sortable="true" data-field="product_id"><?= get_label('product_id', 'Meal') ?></th>
                        <th data-sortable="true" data-field="service_date"><?= get_label('service_date', 'Service Date') ?></th>
                        <th data-sortable="true" data-field="service_time"><?= get_label('service_time', 'Service Time') ?></th>
                        <th data-sortable="true" data-field="quantity"><?= get_label('quantity', 'Quantity') ?></th>
                        <th data-sortable="true" data-field="unit_price"><?= get_label('unit_price', 'Unit Price') ?></th>
