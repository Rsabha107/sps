...
<div class="card mt-4">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <div class="mx-2 mb-2">
                <table  id="procurement_item_unit_type_table"
                        data-toggle="table"
                        data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                        data-loading-template="loadingTemplate"
                        data-url="{{ route('procurement.admin.setting.unit-type.list')}}"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-sortable="true" data-field="title"><?= get_label('title', 'Name') ?></th>
...
function queryParams(p) {
    return {
        status: $("#procurement_unit_type_filter").val(),
