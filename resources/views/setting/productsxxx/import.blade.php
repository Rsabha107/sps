...
<div class="content">
            ...
            <div class="col-xl-8">
                <div class="d-sm-flex justify-content-between">
                    ...
                    <div class="d-flex mb-3">
                        <a class="btn btn-phoenix-danger me-2 px-6" href="{{ route('mds.setting.schedule') }}">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xl-8">
            <form action="{{ route ('mds.setting.schedule.import.store') }}" class="row g-3 mb-9 needs-validation" novalidate="" method="post" enctype="multipart/form-data">
                @csrf
