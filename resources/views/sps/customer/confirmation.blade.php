                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <div class="card p-4">
                            ...
                            <p class="fs-9 text-body-tertiary fw-bold mb-1 mt-2 white-space-nowrap"><strong>Refernce#:</strong> {{ $profile->ref_number ?? $profile->id }}</p>
                            <p class="fs-9 text-body-tertiary fw-bold mb-1 white-space-nowrap"><strong>Phone:</strong> {{ $profile->phone }}</p>
                            <p class="fs-9 text-body-tertiary fw-bold mb-1 white-space-nowrap"><strong>email:</strong> {{ $profile->email_address }}</p>
                            <p class="fs-9 text-body-tertiary fw-bold mb-1 white-space-nowrap"><strong># of items:</strong> {{ $profile->items->count() }}</p>
