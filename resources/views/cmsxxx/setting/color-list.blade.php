                                        ...
                                        <table class="table table-sm table-responsive fs--1 mb-0 overflow-hidden"
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="javascript:void(0)" class="btn btn-sm " id="editX" data-toggle="modal" data-target='#editModal' data-route="color" data-id="{{ $item->id }}">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            <a href="{{ route('tracki.setup.color.delete',$item->id)}} " class="btn btn-sm  delete" id="delete">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('tracki.setup.color.create') }}" method="POST" >
                @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('tracki.setup.color.update') }}" method="POST" >
                @csrf
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
