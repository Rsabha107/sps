                ...
                <div class="col-12 col-xl-10 col-xxl-8">
                    ...
                    <div class="col-12 col-lg-6 text-center text-lg-start"><img
                        ...
                        <div
                            ...
                            <form class="position-relative" action="{{ route('cms.contractor.orders.event.switch') }}" method="POST">
                                @csrf
                        ...
                        <a class="btn btn-lg btn-secondary w-100" href="{{ route('cms.contractor') }}">Request Access</a>
                    </div>
                </div>
            </div>
        </div>
