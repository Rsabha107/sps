        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('cms.admin.users.profile') }}">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="tab-content pt-4" id="profileTabContent">
                                    <div class="tab-pane fade show active" id="profile-tab-pane" role="tabpanel"
                                        ...
                                        <form action="{{ route('mds.admin.users.profile.update') }}" method="POST"
                                    ...
                                    <div class="tab-pane fade" id="password-tab-pane" role="tabpanel"
                                        ...
                                        <form action="{{ route('mds.admin.users.profile.password.update') }}" method="POST"
                                            enctype="multipart/form-data" class="row gy-3 gy-xxl-4 needs-validation" novalidate>
                                            @csrf
