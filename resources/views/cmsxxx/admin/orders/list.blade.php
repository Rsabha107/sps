...
@section('main')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between mb-2 mt-2">
            ...
            ></x-formy.button_insert_js> --}}
                <a class="btn btn-phoenix-primary px-3 me-1 ms-3" href="{{ route('cms.admin.orders', ['vw' => 'list']) }}"
                ...
                <a class="btn btn-phoenix-primary px-3 me-1 border-0 text-body"
                    href="{{ route('cms.admin.orders', ['vw' => 'lines']) }}" data-bs-toggle="tooltip"
        ...
        @elseif ($view_type == 'lines')
            <x-cms.orders.admin-order-lines-card />
        @endif
